...
_pa.segments = [{"name":"All visitors","id":745474,"regex":".*"},{"name":"Viewed Pricing","id":747516,"regex":"/pricing/?([?#].*)*$"},{"name":"succesfully signed up","id":754743,"regex":"https?:\\/\\/app.pusher.com\\/apps\\/[0-9]+\\/api_access\\?welcome=true"},{"name":"Visited the blog","id":812331,"regex":"blog\\.pusher\\.com"}];
_pa.conversions = [{"name":"Signed up","id":"79872","regex":"\\?.*welcome=true"}];
_pa.conversionEvents = [{"name":"Signed Up","id":"186075"}];
_pa.segmentEvents = [{"name":"Signed Up","id":1684884}];
_pa.rtbId = '12944';
_pa.siteId = '519a3b8368bd1dfb7800000e';
