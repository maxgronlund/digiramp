...
ActiveRecord::Schema.define(version: 20151204172543) do
  ...
  create_table "account_users", force: :cascade do |t|
    ...
    t.boolean  "download_recording",                    default: false
  end
  ...
  create_table "admin_legal_tags", force: :cascade do |t|
    t.string   "title"
    t.text     "body"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "has_wrote_a_recording_comment"
    t.boolean  "has_wrote_a_user_comment"
    t.boolean  "has_wrote_a_playlist_comment"
    t.boolean  "has_liked_a_user"
    t.boolean  "user_configuration_configured"
    t.boolean  "has_shared_a_recording",                    default: false
  end
