...
RSpec.describe "creative_projects/new", :type => :view do
  before(:each) do
    assign(:creative_project, CreativeProject.new(
      :title => "MyString",
      :description => "MyText",
      :user => nil,
      :account => nil,
  ...
  it "renders new creative_project form" do
    render

    assert_select "form[action=?][method=?]", creative_projects_path, "post" do
