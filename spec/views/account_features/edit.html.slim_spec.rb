...
RSpec.describe "account_features/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit account_feature form" do
    render

    assert_select "form[action=?][method=?]", account_feature_path(@account_feature), "post" do
