...
RSpec.describe "front_end_contents/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit front_end_content form" do
    render

    assert_select "form[action=?][method=?]", front_end_content_path(@front_end_content), "post" do
