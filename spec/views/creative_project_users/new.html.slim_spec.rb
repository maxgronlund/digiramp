...
RSpec.describe "creative_project_users/new", :type => :view do
  before(:each) do
    assign(:creative_project_user, CreativeProjectUser.new(
  ...
  it "renders new creative_project_user form" do
    render

    assert_select "form[action=?][method=?]", creative_project_users_path, "post" do
