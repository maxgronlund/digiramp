...
RSpec.describe "digital_signatures/new", type: :view do
  before(:each) do
    assign(:digital_signature, DigitalSignature.new(
      :uuid => "MyString",
      :user => nil,
      :account => nil,
      :document => nil,
  ...
  it "renders new digital_signature form" do
    render

    assert_select "form[action=?][method=?]", digital_signatures_path, "post" do
