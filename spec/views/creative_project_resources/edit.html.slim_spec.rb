...
RSpec.describe "creative_project_resources/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit creative_project_resource form" do
    render

    assert_select "form[action=?][method=?]", creative_project_resource_path(@creative_project_resource), "post" do
