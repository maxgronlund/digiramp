...
RSpec.describe "document_users/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit document_user form" do
    render

    assert_select "form[action=?][method=?]", document_user_path(@document_user), "post" do
