...
RSpec.describe "digiramp_ads/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit digiramp_ad form" do
    render

    assert_select "form[action=?][method=?]", digiramp_ad_path(@digiramp_ad), "post" do
