...
RSpec.describe "user_configurations/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit user_configuration form" do
    render

    assert_select "form[action=?][method=?]", user_configuration_path(@user_configuration), "post" do
