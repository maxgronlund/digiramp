  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created instruction" do
        post :create, {:instruction => valid_attributes}, valid_session
        expect(response).to redirect_to(Instruction.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved instruction as @instruction" do
        post :create, {:instruction => invalid_attributes}, valid_session
        expect(assigns(:instruction)).to be_a_new(Instruction)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested instruction" do
        instruction = Instruction.create! valid_attributes
        put :update, {:id => instruction.to_param, :instruction => new_attributes}, valid_session
        instruction.reload
      ...
      it "redirects to the instruction" do
        instruction = Instruction.create! valid_attributes
        put :update, {:id => instruction.to_param, :instruction => valid_attributes}, valid_session
        expect(response).to redirect_to(instruction)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the instruction as @instruction" do
        instruction = Instruction.create! valid_attributes
        put :update, {:id => instruction.to_param, :instruction => invalid_attributes}, valid_session
        expect(assigns(:instruction)).to eq(instruction)
      end
