  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved forum as @forum" do
        post :create, {:forum => invalid_attributes}, valid_session
        expect(assigns(:forum)).to be_a_new(Forum)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested forum" do
        forum = Forum.create! valid_attributes
        put :update, {:id => forum.to_param, :forum => new_attributes}, valid_session
        forum.reload
    ...
    describe "with invalid params" do
      it "assigns the forum as @forum" do
        forum = Forum.create! valid_attributes
        put :update, {:id => forum.to_param, :forum => invalid_attributes}, valid_session
        expect(assigns(:forum)).to eq(forum)
      end
